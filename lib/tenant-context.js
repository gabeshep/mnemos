...
/**
 * Executes `fn(client, db)` inside a transaction scoped to `tenantId`.
 *
 * `fn` receives a raw pg Client and should use it for all queries within
 * the transaction. The RLS parameter is set before `fn` runs.
 *
